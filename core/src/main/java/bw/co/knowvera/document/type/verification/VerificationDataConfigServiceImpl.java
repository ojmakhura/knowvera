 ...
 * MODEL CLASS: AndroMDAModel::backend::bw.co.knowvera::document::type::verification::VerificationDataConfigService
 * STEREOTYPE:  Service
 */
...
import bw.co.knowvera.document.type.verification.VerificationDataConfigServiceBase;
...
/**
 * @see bw.co.knowvera.document.type.verification.VerificationDataConfigService
 */
    ...
    extends VerificationDataConfigServiceBase
{
    ...
    /**
     * @see bw.co.knowvera.document.type.verification.VerificationDataConfigService#findById(String)
     */
    @Override
    ...
    /**
     * @see bw.co.knowvera.document.type.verification.VerificationDataConfigService#save(@Valid VerificationDataConfigDTO)
     */
    @Override
    ...
    /**
     * @see bw.co.knowvera.document.type.verification.VerificationDataConfigService#remove(String)
     */
    @Override
