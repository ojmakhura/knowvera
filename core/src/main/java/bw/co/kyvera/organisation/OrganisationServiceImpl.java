 ...
 * MODEL CLASS: AndroMDAModel::backend::bw.co.kyvera::organisation::OrganisationService
 * STEREOTYPE:  Service
 */
...
/**
 * @see bw.co.kyvera.organisation.OrganisationService
 */
...
public class OrganisationServiceImpl
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#findById(String)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#getAll()
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#getAll(Integer,
     *      Integer)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#remove(String)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#save(OrganisationDTO)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#search(String)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.organisation.OrganisationService#search(Integer,
     *      Integer, String)
     */
    @Override
