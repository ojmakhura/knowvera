 ...
 * MODEL CLASS: AndroMDAModel::backend::bw.co.kyvera::contact::ContactService
 * STEREOTYPE:  Service
 */
...
/**
 * @see bw.co.kyvera.contact.ContactService
 */
...
public class ContactServiceImpl
    ...
    /**
     * @see bw.co.kyvera.contact.ContactService#findById(String)
     */
    @Override
    protected ContactDTO handleFindById(String id)
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleFindById(String id) Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#save(ContactDTO)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.contact.ContactService#remove(String)
     */
    @Override
    protected boolean handleRemove(String id)
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleRemove(String id) Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#getAll()
     */
    @Override
    protected List<ContactDTO> handleGetAll()
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleGetAll() Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#search(String)
     */
    @Override
    protected List<ContactDTO> handleSearch(String criteria)
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleSearch(String criteria) Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#getAll(Integer, Integer)
     */
    @Override
    protected Page<ContactDTO> handleGetAll(Integer pageNumber, Integer pageSize)
        ...
        // Integer pageSize)
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleGetAll(Integer pageNumber, Integer pageSize) Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#findByType(ContactType)
     */
    @Override
    protected List<ContactDTO> handleFindByType(ContactType type)
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleFindByType(ContactType type) Not implemented!");
    }

    /**
     * @see bw.co.kyvera.contact.ContactService#findByType(ContactType, Integer,
     *      Integer)
     */
    @Override
    protected Page<ContactDTO> handleFindByType(ContactType type, Integer pageNumber, Integer pageSize)
        ...
        throw new UnsupportedOperationException(
                "bw.co.kyvera.contact.ContactService.handleFindByType(ContactType type, Integer pageNumber, Integer pageSize) Not implemented!");
    }
