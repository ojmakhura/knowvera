 ...
 * MODEL CLASS: AndroMDAModel::backend::bw.co.kyvera::document::type::verification::VerificationDataConfigService
 * STEREOTYPE:  Service
 */
...
/**
 * @see bw.co.kyvera.document.type.verification.VerificationDataConfigService
 */
    ...
    extends VerificationDataConfigServiceBase
{
    ...
    /**
     * @see bw.co.kyvera.document.type.verification.VerificationDataConfigService#findById(String)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.document.type.verification.VerificationDataConfigService#save(@Valid VerificationDataConfigDTO)
     */
    @Override
    ...
    /**
     * @see bw.co.kyvera.document.type.verification.VerificationDataConfigService#remove(String)
     */
    @Override
