...
import bw.co.kyvera.contact.Contact;
import bw.co.kyvera.contact.ContactDTO;
import bw.co.kyvera.contact.ContactMapper;
import bw.co.kyvera.contact.ContactType;
...
import bw.co.kyvera.individual.EmploymentStatus;
import bw.co.kyvera.individual.Individual;
import bw.co.kyvera.individual.IndividualDTO;
import bw.co.kyvera.individual.IndividualIdentityType;
import bw.co.kyvera.individual.IndividualListDTO;
import bw.co.kyvera.individual.IndividualMapper;
import bw.co.kyvera.individual.MaritalStatus;
import bw.co.kyvera.individual.PepStatus;
import bw.co.kyvera.individual.Sex;
import bw.co.kyvera.individual.employment.EmploymentRecord;
import bw.co.kyvera.individual.employment.EmploymentRecordDTO;
import bw.co.kyvera.individual.employment.EmploymentRecordMapper;
import bw.co.kyvera.invoice.KycInvoice;
import bw.co.kyvera.invoice.KycInvoiceDTO;
...
import bw.co.kyvera.kyc.KycRecordMapper;
import bw.co.kyvera.settings.kyc.GroupField;
import bw.co.kyvera.settings.kyc.GroupFieldDTO;
import bw.co.kyvera.settings.kyc.GroupFieldMapper;
import bw.co.kyvera.kyc.fields.GroupFieldValue;
import bw.co.kyvera.kyc.fields.GroupFieldValueDTO;
import bw.co.kyvera.kyc.fields.GroupFieldValueMapper;
import bw.co.kyvera.kyc.fields.KycReportSection;
import bw.co.kyvera.kyc.fields.KycReportSectionDTO;
import bw.co.kyvera.kyc.fields.KycReportSectionMapper;
...
import bw.co.kyvera.organisation.branch.Branch;
import bw.co.kyvera.organisation.branch.BranchDTO;
import bw.co.kyvera.organisation.branch.BranchMapper;
import bw.co.kyvera.organisation.client.ClientRequest;
import bw.co.kyvera.organisation.client.ClientRequestDTO;
import bw.co.kyvera.organisation.client.ClientRequestMapper;
import bw.co.kyvera.organisation.client.ClientRequestStatus;
import bw.co.kyvera.organisation.document.OrganisationDocument;
import bw.co.kyvera.organisation.document.OrganisationDocumentDTO;
import bw.co.kyvera.organisation.document.OrganisationDocumentMapper;
import bw.co.kyvera.organisation.document.OrganisationDocumentStatus;
import bw.co.kyvera.sequence.SequencePart;
import bw.co.kyvera.sequence.SequencePartDTO;
import bw.co.kyvera.sequence.SequencePartMapper;
import bw.co.kyvera.sequence.SequencePartType;
import bw.co.kyvera.settings.SalaryRange;
import bw.co.kyvera.settings.SalaryRangeDTO;
import bw.co.kyvera.settings.SalaryRangeMapper;
...
import bw.co.kyvera.settings.kyc.KycFieldGroupDTO;
import bw.co.kyvera.settings.kyc.KycFieldGroupMapper;
import bw.co.kyvera.subscription.KycSubsciptionStatus;
import bw.co.kyvera.subscription.KycSubscription;
import bw.co.kyvera.subscription.KycSubscriptionDTO;
import bw.co.kyvera.subscription.KycSubscriptionMapper;
...
class MapperCoverageTest {
    ...
    void wireMappers() {
        ...
        inject(contactMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(branchMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        inject(branchMapper, "documentMapper", documentMapper);

        inject(verificationDataConfigMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        inject(verificationDataConfigMapper, "expectedFieldMapper", expectedFieldMapper);

        inject(expectedFieldMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(documentTypeMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(sequencePartMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(salaryRangeMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(groupFieldMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(kycFieldGroupMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(documentMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(documentMapper, "individualRepository", mock(bw.co.kyvera.individual.IndividualRepository.class));
        inject(documentMapper, "organisationRepository", mock(bw.co.kyvera.organisation.OrganisationRepository.class));
        inject(documentMapper, "kycRecordRepository", mock(bw.co.kyvera.kyc.KycRecordRepository.class));

        inject(organisationDocumentMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        inject(organisationDocumentMapper, "documentTypeMapper", documentTypeMapper);

        inject(clientRequestMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(settingsMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(individualMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(employmentRecordMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(kycSubscriptionMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());

        inject(kycInvoiceMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        inject(kycInvoiceMapper, "documentMapper", documentMapper);
        inject(kycInvoiceMapper, "kycSubscriptionMapper", kycSubscriptionMapper);

        inject(groupFieldValueMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
        ...
        inject(kycRecordMapper, "mappingUtils", new bw.co.kyvera.utils.MappingUtils());
    ...
    void organisationMapperCoversBothDirections() {
        ...
        organisation.setStatus(bw.co.kyvera.GeneralStatus.ACTIVE);
        ...
        input.setStatus(bw.co.kyvera.GeneralStatus.ACTIVE);
    ...
    void clientRequestMapperCoversBothDirections() {
        ...
        request.setTarget(bw.co.kyvera.TargetEntity.ORGANISATION);
        ...
        assertEquals(bw.co.kyvera.TargetEntity.ORGANISATION, entity.getTarget());
    ...
    void organisationDocumentMapperCoversBothDirections() {
        ...
        document.setTarget(bw.co.kyvera.TargetEntity.ORGANISATION);
    ...
    void expectedFieldMapperCoversBothDirections() {
        ...
        field.setTargetType(bw.co.kyvera.TargetEntity.INDIVIDUAL);
        field.setFieldType(bw.co.kyvera.document.type.field.ExpectedFieldType.STRING);
        ...
        input.setTargetType(bw.co.kyvera.TargetEntity.INDIVIDUAL);
        input.setFieldType(bw.co.kyvera.document.type.field.ExpectedFieldType.STRING);
        ...
        assertEquals(bw.co.kyvera.TargetEntity.INDIVIDUAL, entity.getTargetType());
    }
    ...
    void kycFieldGroupMapperCoversBothDirections() {
        ...
        group.setTargetType(bw.co.kyvera.TargetEntity.INDIVIDUAL);
        group.setPosition(1);
    ...
    void kycSubscriptionMapperCoversBothDirections() {
        ...
        subscription.setPeriod(bw.co.kyvera.TimePeriod.MONTH);
    ...
    void documentMapperCoversBothDirections() {
        ...
        document.setAnalyticsStatus(bw.co.kyvera.document.DocumentAnalyticsStatus.INITIALISED);
        ...
        input.setAnalyticsStatus(bw.co.kyvera.document.DocumentAnalyticsStatus.INITIALISED);
    ...
    void kycRecordMapperCoversBothDirections() {
        ...
        record.setTarget(bw.co.kyvera.TargetEntity.INDIVIDUAL);
        ...
        input.setTarget(bw.co.kyvera.TargetEntity.INDIVIDUAL);
        ...
        assertEquals(bw.co.kyvera.TargetEntity.INDIVIDUAL, entity.getTarget());
    }
