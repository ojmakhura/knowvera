...
import bw.co.centralkyc.contact.Contact;
import bw.co.centralkyc.contact.ContactDTO;
import bw.co.centralkyc.contact.ContactMapper;
import bw.co.centralkyc.contact.ContactType;
...
import bw.co.centralkyc.individual.EmploymentStatus;
...
import bw.co.centralkyc.individual.IndividualListDTO;
import bw.co.centralkyc.individual.IndividualMapper;
import bw.co.centralkyc.individual.MaritalStatus;
...
import bw.co.centralkyc.settings.kyc.GroupFieldDTO;
import bw.co.centralkyc.settings.kyc.GroupFieldMapper;
import bw.co.centralkyc.kyc.fields.GroupFieldValue;
import bw.co.centralkyc.kyc.fields.GroupFieldValueDTO;
import bw.co.centralkyc.kyc.fields.GroupFieldValueMapper;
import bw.co.centralkyc.kyc.fields.KycReportSection;
import bw.co.centralkyc.kyc.fields.KycReportSectionDTO;
...
import bw.co.centralkyc.organisation.branch.Branch;
...
import bw.co.centralkyc.organisation.client.ClientRequestStatus;
import bw.co.centralkyc.organisation.document.OrganisationDocument;
import bw.co.centralkyc.organisation.document.OrganisationDocumentDTO;
import bw.co.centralkyc.organisation.document.OrganisationDocumentMapper;
import bw.co.centralkyc.organisation.document.OrganisationDocumentStatus;
import bw.co.centralkyc.sequence.SequencePart;
import bw.co.centralkyc.sequence.SequencePartDTO;
import bw.co.centralkyc.sequence.SequencePartMapper;
import bw.co.centralkyc.sequence.SequencePartType;
import bw.co.centralkyc.settings.SalaryRange;
import bw.co.centralkyc.settings.SalaryRangeDTO;
...
class MapperCoverageTest {
    ...
    void wireMappers() {
        ...
        inject(contactMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(branchMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        inject(branchMapper, "documentMapper", documentMapper);

        inject(verificationDataConfigMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        inject(verificationDataConfigMapper, "expectedFieldMapper", expectedFieldMapper);

        inject(expectedFieldMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(documentTypeMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(sequencePartMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(salaryRangeMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(groupFieldMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(kycFieldGroupMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(documentMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(documentMapper, "individualRepository", mock(bw.co.centralkyc.individual.IndividualRepository.class));
        inject(documentMapper, "organisationRepository", mock(bw.co.centralkyc.organisation.OrganisationRepository.class));
        inject(documentMapper, "kycRecordRepository", mock(bw.co.centralkyc.kyc.KycRecordRepository.class));

        inject(organisationDocumentMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        inject(organisationDocumentMapper, "documentTypeMapper", documentTypeMapper);

        inject(clientRequestMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(settingsMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(individualMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(employmentRecordMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(kycSubscriptionMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());

        inject(kycInvoiceMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        inject(kycInvoiceMapper, "documentMapper", documentMapper);
        inject(kycInvoiceMapper, "kycSubscriptionMapper", kycSubscriptionMapper);

        inject(groupFieldValueMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
        ...
        inject(kycRecordMapper, "mappingUtils", new bw.co.centralkyc.utils.MappingUtils());
    ...
    void organisationMapperCoversBothDirections() {
        ...
        organisation.setStatus(bw.co.centralkyc.GeneralStatus.ACTIVE);
        ...
        input.setStatus(bw.co.centralkyc.GeneralStatus.ACTIVE);
    ...
    void clientRequestMapperCoversBothDirections() {
        ...
        request.setTarget(bw.co.centralkyc.TargetEntity.ORGANISATION);
        ...
        assertEquals(bw.co.centralkyc.TargetEntity.ORGANISATION, entity.getTarget());
    ...
    void organisationDocumentMapperCoversBothDirections() {
        ...
        document.setTarget(bw.co.centralkyc.TargetEntity.ORGANISATION);
    ...
    void expectedFieldMapperCoversBothDirections() {
        ...
        field.setTargetType(bw.co.centralkyc.TargetEntity.INDIVIDUAL);
        field.setFieldType(bw.co.centralkyc.document.type.field.ExpectedFieldType.STRING);
        ...
        input.setFieldType(bw.co.centralkyc.document.type.field.ExpectedFieldType.STRING);
        ...
        assertEquals(bw.co.centralkyc.TargetEntity.INDIVIDUAL, entity.getTargetType());
    }
    ...
    void kycFieldGroupMapperCoversBothDirections() {
        ...
        group.setTargetType(bw.co.centralkyc.TargetEntity.INDIVIDUAL);
        group.setPosition(1);
    ...
    void kycSubscriptionMapperCoversBothDirections() {
        ...
        subscription.setPeriod(bw.co.centralkyc.TimePeriod.MONTH);
    ...
    void documentMapperCoversBothDirections() {
        ...
        document.setAnalyticsStatus(bw.co.centralkyc.document.DocumentAnalyticsStatus.INITIALISED);
        ...
        input.setAnalyticsStatus(bw.co.centralkyc.document.DocumentAnalyticsStatus.INITIALISED);
    ...
    void kycRecordMapperCoversBothDirections() {
        ...
        record.setTarget(bw.co.centralkyc.TargetEntity.INDIVIDUAL);
        ...
        input.setTarget(bw.co.centralkyc.TargetEntity.INDIVIDUAL);
        ...
        assertEquals(bw.co.centralkyc.TargetEntity.INDIVIDUAL, entity.getTarget());
    }
