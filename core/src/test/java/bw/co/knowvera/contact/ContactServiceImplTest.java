...
import bw.co.knowvera.contact.ContactServiceImpl;
...
class ContactServiceImplTest {
    ...
    void findByIdThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                () -> service.findById(id),
                "bw.co.knowvera.contact.ContactService.findById(String id) Not implemented!");
    }
    ...
    void removeThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                () -> service.remove(id),
                "bw.co.knowvera.contact.ContactService.remove(String id) Not implemented!");
    }
    ...
    void getAllNoArgsThrowsUnsupportedOperationException() {
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                () -> service.getAll(),
                "bw.co.knowvera.contact.ContactService.getAll() Not implemented!");
    }
    ...
    void searchThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                ...
                "bw.co.knowvera.contact.ContactService.search(String criteria) Not implemented!");
    }
    ...
    void getAllWithPaginationThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                ...
                "bw.co.knowvera.contact.ContactService.getAll(Integer pageNumber, Integer pageSize) Not implemented!");
    }
    ...
    void findByTypeNoArgsThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                ...
                "bw.co.knowvera.contact.ContactService.findByType(ContactType type) Not implemented!");
    }
    ...
    void findByTypeWithPaginationThrowsUnsupportedOperationException() {
        ...
        org.junit.jupiter.api.Assertions.assertThrows(
            ContactServiceException.class,
                ...
                "bw.co.knowvera.contact.ContactService.findByType(ContactType type, Integer pageNumber, Integer pageSize) Not implemented!");
    }
