...
import { KycRecordApiStore } from '@store/bw/co/kyvera/kyc/kyc-record-api.store';
...
import { KycRecordSearchCriteria } from '@models/bw/co/kyvera/kyc/kyc-record-search-criteria';
