...
import { KycRecordApiStore } from '@store/bw/co/knowvera/kyc/kyc-record-api.store';
...
import { KycRecordSearchCriteria } from '@models/bw/co/knowvera/kyc/kyc-record-search-criteria';
