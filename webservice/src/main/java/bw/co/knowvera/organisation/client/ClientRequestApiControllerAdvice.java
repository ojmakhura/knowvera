...
public class ClientRequestApiControllerAdvice {
    ...
    private static final List<ValidationMapping> VALIDATION_MAPPINGS = List.of(
            ...
            new ValidationMapping(".save(", "'clientRequest'",
            ...
            new ValidationMapping(".findByStatus(", "'status'",
                    "Status is required."),
            ...
            new ValidationMapping(".findByDocument(", "'documentId'",
                    "Document Id is required."),

            new ValidationMapping(".findByDocumentPaged(", "'documentId'",
                    "Document Id is required."),

            new ValidationMapping(".findByStatusPaged(", "'status'",
                    "Status is required."),

            new ValidationMapping(".uploadRequests(", "'file'",
                    "File is required."),
            ...
            new ValidationMapping(".findByTargetPaged(", "'target'",
                    "Target is required."),
            new ValidationMapping(".findByTargetPaged(", "'targetId'",
                    "Target Id is required."),

            new ValidationMapping(".findOrganisationsByOrganisation(", "'organisationId'",
                    "Organisation Id is required."),

            new ValidationMapping(".findIndividualsByOrganisation(", "'organisationId'",
                    "Organisation Id is required."),

            new ValidationMapping(".findOrganisationsByOrganisationPaged(", "'organisationId'",
                    "Organisation Id is required."),

            new ValidationMapping(".findIndividualsByOrganisationPaged(", "'organisationId'",
                    "Organisation Id is required."),

            new ValidationMapping(".updateStatus(", "'id'",
                    "Id is required."),
            new ValidationMapping(".updateStatus(", "'status'",
                    "Status is required."),

            new ValidationMapping(".confirmToken(", "'requestId'",
                    "Request Id is required."),
            new ValidationMapping(".confirmToken(", "'token'",
                    "Token is required."),

            new ValidationMapping(".confirmRegistration(", "'id'",
                    "Id is required."),
            new ValidationMapping(".confirmRegistration(", "'registrationToken'",
    ...
    public ResponseEntity<ProblemDetail> handleIllegalArgument(
        ...
        ProblemDetail problemDetail = buildProblemDetail(
                ...
                "ClientRequestApi validation failed",
                friendly,
                request,
                errors
        );
    ...
    public ResponseEntity<ProblemDetail> handleClientRequestServiceException(
        ...
        ProblemDetail problemDetail = buildProblemDetail(
                ...
                "service-error",
                "ClientRequestApi service error",
    ...
    /**
     * Maps validation messages thrown by ClientRequestApiServiceBase to
