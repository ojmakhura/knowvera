...
public class BranchApiControllerAdvice {
    ...
    private static final List<ValidationMapping> VALIDATION_MAPPINGS = List.of(
            ...
            new ValidationMapping(".save(", "'branch'",
                    "Branch is required."),
    ...
    public ResponseEntity<ProblemDetail> handleBranchServiceException(
            BranchServiceException ex,
            WebRequest request) {
    ...
    /**
     * Maps validation messages thrown by BranchApiServiceBase to
