...
import bw.co.knowvera.extractor.LmStudioExtractorService;
...
import bw.co.knowvera.llm.PromptMessage;
...
public class DocumentValidationService {
    ...
    private void lmStudioConfirmation(DocumentDTO document) {
        ...
        bw.co.knowvera.llm.Prompt completionRequest = new bw.co.knowvera.llm.Prompt();
