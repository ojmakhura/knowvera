...
public class IndividualApiControllerAdvice {
    ...
    private static final List<ValidationMapping> VALIDATION_MAPPINGS = List.of(
            ...
            new ValidationMapping(".save(", "'individual'",
            ...
            new ValidationMapping(".getOrganisationClientsPaged(", "'organisationId'",
                    "Organisation Id is required."),

            new ValidationMapping(".loadRequestIndividual(", "'requestId'",
                    "Request Id is required."),
            new ValidationMapping(".loadRequestIndividual(", "'identityConfirmationToken'",
                    "Identity Confirmation Token is required."),
            new ValidationMapping(".loadRequestIndividual(", "'identityNo'",
                    "Identity No is required."),

            new ValidationMapping(".verifyIndividual(", "'id'",
                    "Id is required.")
    );
    ...
    public ResponseEntity<ProblemDetail> handleIllegalArgument(
        ...
        ProblemDetail problemDetail = buildProblemDetail(
                ...
                "IndividualApi validation failed",
                friendly,
                request,
                errors
        );
    ...
    /**
     * Maps validation messages thrown by IndividualApiServiceBase to
