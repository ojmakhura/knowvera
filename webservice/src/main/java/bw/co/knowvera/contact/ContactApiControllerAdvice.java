...
public class ContactApiControllerAdvice {
    ...
    private static final List<ValidationMapping> VALIDATION_MAPPINGS = List.of(
            ...
            new ValidationMapping(".findByType(", "'type'",
                    "Type is required."),

            new ValidationMapping(".findByTypePaged(", "'type'",
                    "Type is required.")
    );
    ...
    public ResponseEntity<ProblemDetail> handleContactServiceException(
            ContactServiceException ex,
            WebRequest request) {
    ...
    /**
     * Maps validation messages thrown by ContactApiServiceBase to
